...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-black">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-zinc-400 mb-12 max-w-2xl mx-auto leading-relaxed">
              Experience seamless urban mobility with real-time traffic
              management, smart routing, and sustainable transportation
              solutions.
            </p>
            ...
            <div className="mt-16 grid grid-cols-1 md:grid-cols-4 gap-6">
              {[
                ...
                <div
                  key={stat.label}
                  className="bg-zinc-900/50 backdrop-blur-sm border border-zinc-800 rounded-xl p-6 hover:border-purple-500/50 transition-all duration-300"
                >
                  <div
                    className={`p-3 bg-${stat.color}-500/20 rounded-lg w-fit mb-4`}
                  >
      ...
      <div
        id="features"
        className="relative py-32 bg-gradient-to-b from-black via-zinc-900 to-black"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-zinc-400 max-w-2xl mx-auto">
              Our comprehensive suite of tools helps you navigate urban traffic
              efficiently while promoting sustainable transportation.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Get instant updates on traffic conditions and estimated relief times.",
                color: "purple",
              },
              {
                icon: MapPin,
                title: "Smart Routing",
                description:
                  "AI-powered route optimization for the fastest path to your destination.",
                color: "pink",
              },
              {
                icon: Package,
                ...
                description:
                  "Order food and essentials from nearby locations with smart routing.",
                color: "orange",
              },
              {
                icon: Car,
                ...
                description:
                  "Access various transport modes from bikes to car services.",
                color: "blue",
              },
              {
                icon: Shield,
              ...
              },
              {
                ...
                title: "Eco Impact",
                description:
                  "Track and reduce your carbon footprint with green transport options.",
                color: "green",
              },
            ].map((feature, index) => (
              <div
              ...
              >
                <div
                  className={`p-4 bg-${feature.color}-500/20 rounded-lg w-fit mb-6 group-hover:scale-110 transform transition-transform`}
                >
                  <feature.icon
